<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RefundInfo.aspx.cs" Inherits="Reporter.ReportForm.RefundInfo" %>
            ...
            <div id="main_body" class="clearfix">
                ...
                <div id="main_reporter" class="clearfix">
                    <ul id="location" class="clearfix">
                        ...
                        <li><a href="#">退菜发票分析</a><span class="icon-angle-right"></span></li>
                        <li id="location_li"><a href="#">退菜分析表</a>
                            <ul>
                                <li><a href="Receipt.aspx">发票分析表</a></li>
                                <li><a href="SalesCount.aspx">赠菜分析表</a></li>
                                <li><a href="SalesCount.aspx">支付方式表</a></li>
                            </ul>
                        </li>
                    </ul>
                    <div class="reporter_area">
                        ...
                        <table data-toggle="table" data-height="450" data-pagination="true" id="table" data-url="" data-sort-name="date" data-sort-order="asc">
                            <thead>
                                <tr>
                                    <th data-field="id" rowspan="2">订单号</th>
                                    <th data-field="time"  data-align="left" rowspan="2">日期</th>
                                    <th data-align="center" data-valign="middle" colspan="3">菜品信息</th>
                                    <th data-align="center"  data-valign="middle" colspan="2">应退价格</th>
                                </tr>
                                <tr>
                                    <th data-field="name">菜品</th>
                                    <th data-field="price"  data-align="left">单价</th>
                                    <th data-field="num"  data-align="right">数量</th>
                                    <th data-field="sPrice"  data-align="right">应付金额</th>
                                    <th data-field="disPrice"  data-align="right">实际金额</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
