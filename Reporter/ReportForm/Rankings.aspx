<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Rankings.aspx.cs" Inherits="Reporter.ReportForm.Rankings" %>
            ...
            <div id="main_body" class="clearfix">
                ...
                <div id="main_reporter" class="clearfix">
                    <ul id="location" class="clearfix">
                        ...
                        <li id="location_li"><a href="#">商品销售排行榜</a>
                            <ul>
                                <li><a href="WePay.aspx">支付对账表</a></li>
                        ...
                        <table data-toggle="table" data-height="450" data-pagination="true" id="table" data-url="" data-sort-name="id" data-sort-order="asc">
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="name"  data-align="center">菜名</th>
                                    <th data-field="price"  data-align="right">单价</th>
                                    <th data-field="num"  data-align="center" data-sortable="true">数量</th>
                                    <th data-field="sale"  data-align="right" data-sortable="true" >销售额</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
