<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesCount.aspx.cs" Inherits="Reporter.ReportForm.SalesCount" %>
            ...
            <div id="main_body" class="clearfix">
                ...
                <div id="main_reporter" class="clearfix">
                    <ul id="location" class="clearfix">
                        ...
                        <li id="location_li"><a href="#">菜品销售统计表</a>
                            <ul>
                                <li><a href="WePay.aspx">支付对账表</a></li>
                                <li><a href="#">商品销售排行榜</a></li>
                            </ul>
                        </li>
                    </ul>
    ...
    <script>
        ...
        $('#search').click(function () {
            ...
            $.ajax({
                ...
                data: "{'beginTime':'" + begin.val() + "','endTime':'" + end.val() + "','dl':'" + $dl.text() + "','xl':'" + $xl.text() + "'}",
                url: "SalesCount.aspx/getData",
                beforeSend: function () {
