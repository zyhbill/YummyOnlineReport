<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Receipt.aspx.cs" Inherits="Reporter.ReportForm.Receipt" %>
            ...
            <div id="main_body" class="clearfix">
                ...
                <div id="main_reporter" class="clearfix">
                    <ul id="location" class="clearfix">
                        ...
                        <li id="location_li"><a href="#">发票分析表</a>
                            <ul>
                                <li><a href="SalesCount.aspx">退菜分析表</a></li>
                        ...
                        <table data-toggle="table" data-height="450" data-pagination="true" id="table" data-url="" data-sort-name="date" data-sort-order="asc">
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="price"  data-align="right">总价</th>
                                    <th data-field="title"  data-align="center">发票抬头</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
