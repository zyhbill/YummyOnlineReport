<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TodaySales.aspx.cs" Inherits="Reporter.ReportForm.TodaySales" %>
...
<body>
            ...
            <div id="main_body" class="clearfix">
                ...
                <div id="main_reporter" class="clearfix">
                    <ul id="location" class="clearfix">
                        ...
                        <li id="location_li"><a href="#">营业日报</a>
                            <ul>
                                <li><a href="#">今日订单</a></li>
                    ...
                    <div class="reporter_area">
                        ...
                        <table data-toggle="table" data-height="450" data-pagination="true" id="table" data-url="" data-sort-name="id" data-sort-order="asc">
                            <thead>
                                <tr>
                                    <th data-field="name" data-align="center">菜品名称</th>
                                    <th data-field="num"  data-align="center">销售数量</th>
                                    <th data-field="price"  data-align="right">应计金额</th>
                                    <th data-field="discount"  data-align="right">折扣金额</th>
    ...
    <script>
        ...
        $('#search').click(function () {
            var $this = $(this);
            var $dl = $('#dl').find('option:selected');
            var $xl = $('#xl').find('option:selected');
            //console.log(begin.val());
            $.ajax({
                type: "post",
                dataType: "json",
                contentType: "application/json;charset=utf-8",
                data: "{'dl':'" + $dl.text() + "','xl':'" + $xl.text() + "'}",
                url: "TodaySales.aspx/getSales",
                beforeSend: function () {
